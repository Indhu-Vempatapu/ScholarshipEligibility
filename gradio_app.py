...
with gr.Blocks() as app:
    ...
    gr.Markdown("""
        <h1 style='text-align: center;'>🎓 Scholarship Eligibility Expert System</h1>
        <div style='text-align: center; font-size: 20px;'>
            Welcome to the <b>Scholarship Eligibility Expert System</b>!<br>
        </div>
        <div style='text-align: left; font-size=19px;'>
                This tool helps you determine your eligibility for various types of scholarships based on your profile.
                <br><br>
                <b>💡 Types of Scholarships Covered:</b><br>
                🎯 <b>Merit-based</b>: Academic or extracurricular excellence<br>
                🏦 <b>Need-based</b>: Financial need<br>
                🌍 <b>International</b>: Studying abroad<br>
                🤝 <b>Underrepresented</b>: Minorities or disadvantaged groups<br>
                📍 <b>Location-specific</b>: Based on region<br>
                📚 <b>Subject-specific</b>: Specific fields of study<br>
                🏫 <b>Institution-specific</b>: College or university-based<br>
                💰 <b>Funding</b>: Special grants or aid
                <br><br>
                👉 Follow the steps below to check your eligibility.
        </div>
    """)
